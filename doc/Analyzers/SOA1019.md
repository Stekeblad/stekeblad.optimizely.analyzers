...
## Initialize property in SetDefaultValues
...
values assigned this way will not show up in the CMS, be rendered on the site,
or be persisted to the database. Properties with an initializer will not have a value
...
This analyzer is a part of a group of analyzers surrounding content property initialization

- [SOA1019 - Initialize property in SetDefaultValues](https://github.com/Stekeblad/stekeblad.optimizely.analyzers/blob/master/doc/Analyzers/SOA1019.md)
...
- See Stekeblad's [SetDefaultValues experiment project](https://github.com/Stekeblad/SetDefaultValues-experiment)
