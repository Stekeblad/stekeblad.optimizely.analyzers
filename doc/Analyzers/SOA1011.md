...
The argument `GUID` on `ScheduledPluginAttribute` is not a valid string
representation of a GUID. See documentation for SOA1008 for more information
and important details surrounding the GUID.
