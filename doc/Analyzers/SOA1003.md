...
- The property needs a getter and setter and both need to be public
...
This will trigger SOA1003:
```c#
// namespace and usings omitted

public class StandardPage : PageData
{
	public string Heading { get; set; } // <-- SOA1003
...
// You can also use standardPage.Property["Heading"]
```
