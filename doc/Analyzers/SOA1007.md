...
to be discovered, exectued and visible in admin. Add the attribute or declare the
scheduled job as abstract to fix.

The attribute also have parameters for many things, including: setting a display name and
description for the job, assigning the job an unique GUID and setting a default intervall.
Some of these are specifically covered by other analyzers in this group.
See the links under "Related analyzers" for more information.
