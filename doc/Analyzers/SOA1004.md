...
It's common to see both attributes to an initialization module.
In that case the InitializableModuleAttribute is redundant but
...
[SOA1025](https://github.com/Stekeblad/stekeblad.optimizely.analyzers/blob/master/doc/Analyzers/SOA1025.md)
covers the non-exiting part.
...
This will trigger SOA1004:
```C#
// namespace and usings omitted

public class MyInitModule : IInitializableModule // <-- SOA1004
{
	// ...
}
```
...
// or with one or more dependencies
