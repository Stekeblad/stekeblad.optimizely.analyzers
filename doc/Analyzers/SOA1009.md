...
Two or more content types cannot have the same GUID assigned to them,
...
for more information and important details surrounding the GUID.

This analyzer only considers usages of `ContentTypeAttribute` and
