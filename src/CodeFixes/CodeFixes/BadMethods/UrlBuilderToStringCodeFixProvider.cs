...
using Analyzer = Stekeblad.Optimizely.Analyzers.Analyzers.BadMethods.UrlBuilderToStringAnalyzer;

namespace Stekeblad.Optimizely.Analyzers.CodeFixes.BadMethods
{
