...
{
	[TestClass]
	public class UseContentTypeAttributeTest : MyTestClassBase
	{
		[TestMethod]
		[DynamicData(nameof(AllOptimizelyTargets))]
		public async Task PageTypeWithFullyDefinedAttribute_NoMatch(ReferenceAssemblies assemblies)
		{
			const string test = @"
		...
		[TestMethod]
		[DynamicData(nameof(AllOptimizelyTargets))]
		public async Task AbstractPageTypeWithoutAttribute_NoMatch(ReferenceAssemblies assemblies)
		{
			const string test = @"
				namespace tests
				{
		...
		[TestMethod]
		[DynamicData(nameof(AllOptimizelyTargets))]
		public async Task MultipleValidContentDefinitions_NoMatch(ReferenceAssemblies assemblies)
		{
			const string test = @"
				using EPiServer.DataAnnotations;
		...
		[TestMethod]
		[DynamicData(nameof(AllOptimizelyTargets))]
		public async Task PageTypeWithoutAttribute_Match(ReferenceAssemblies assemblies)
		{
			const string test =
				@"namespace tests
				{
		...
		[TestMethod]
		[DynamicData(nameof(AllOptimizelyTargets))]
		public async Task AbstractPageTypeWithAttribute_Match(ReferenceAssemblies assemblies)
		{
			const string test = @"
               using EPiServer.DataAnnotations;
				namespace tests
		...
		[TestMethod]
		[DynamicData(nameof(AllOptimizelyTargets))]
		public async Task PageTypeWithAttributeButNoGuid_Match(ReferenceAssemblies assemblies)
		{
			const string test = @"
				namespace tests
				{
		...
		[TestMethod]
		[DynamicData(nameof(AllOptimizelyTargets))]
		public async Task PageTypeWithAttributeAndEmptyGuid_Match(ReferenceAssemblies assemblies)
		{
			const string test = @"
				namespace tests
				{
		...
		[TestMethod]
		[DynamicData(nameof(AllOptimizelyTargets))]
		public async Task PageTypeWithAttributeAndInvalidGuid_Match(ReferenceAssemblies assemblies)
		{
			const string test = @"
				namespace tests
				{
		...
		[TestMethod]
		[DynamicData(nameof(AllOptimizelyTargets))]
		public async Task PageTypeWithAttributeAndReusedGuid_Match(ReferenceAssemblies assemblies)
		{
			const string test = @"
				namespace tests
				{
