...
namespace Stekeblad.Optimizely.Analyzers.Analyzers
{
	...
	public class InitializableModuleMissingInterfaceAnalyzer : MyDiagnosticAnalyzerBase
	{
		...
		public static readonly LocalizableString Title = "Implement the interface IInitializableModule or IConfigurableModule";
		internal static readonly LocalizableString MessageFormat = "'{0}' is decorated with {1} but does not implement the interface IInitializableModule or IConfigurableModule";
